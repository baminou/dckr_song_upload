...
RUN echo "client.connectTimeoutSeconds=18000" >> /icgc-storage-client/conf/application-aws.properties
RUN echo "client.readTimeoutSeconds=18000" >> /icgc-storage-client/conf/application-aws.properties
